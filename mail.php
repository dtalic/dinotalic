...
if(!$_POST) exit;
		...
		if(trim($name) == '') {
        	...
        	echo '<div class="error-message">Attention! Please enter a valid email address.</div>';
			exit();
        } else if(!isEmail($email)) {
        	echo '<div class="error-message">Attention! You have enter an invalid e-mail address, try again.</div>';
			exit();
        }
		
        if(trim($subject) == '') {
        	echo '<div class="error-message">Attention! Please enter a subject.</div>';
			exit();
        } else if(trim($comments) == '') {
        	echo '<div class="error-message">Attention! Please enter your message.</div>';
			exit();
        } else if(trim($verify) == '') {
